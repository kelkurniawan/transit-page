  ...
  return (
    <>
      <nav className={`navbar${scrolled ? " scrolled" : ""}`}>
        <div className="container">
          ...
          <div className="nav-right">
            ...
            <a href={waLink(tWa("prefill.navbar"))} className="btn btn-primary btn-sm nav-cta" target="_blank" rel="noopener noreferrer">
              {t("quote")}
            </a>
            <button
      ...
      <div id="mobile-menu" className={`mobile-menu${menuOpen ? " active" : ""}`}>
        ...
        <a href={waLink(tWa("prefill.navbar"))} className="btn btn-wa" target="_blank" rel="noopener noreferrer">
          {t("quote")}
        </a>
      </div>
    </>
